...
HD_PWD='C:/Users/anuragchoudhury/Desktop/demo/simple_adder/simple_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_simple_adder_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_simple_adder_v1_0.tcl
