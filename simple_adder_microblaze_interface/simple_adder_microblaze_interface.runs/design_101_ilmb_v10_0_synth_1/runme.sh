...
HD_PWD='C:/demo/simple_adder_microblaze_interface/simple_adder_microblaze_interface/simple_adder_microblaze_interface.runs/design_101_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_101_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_101_ilmb_v10_0.tcl
