...
HD_PWD='C:/demo/simple_adder_microblaze_interface/simple_adder_microblaze_interface/simple_adder_microblaze_interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_101_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_101_wrapper.tcl
